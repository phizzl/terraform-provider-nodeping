...
func TestDataSourceMetadata(t *testing.T) {
	...
	NewContactGroupDataSource().Metadata(context.Background(), fwdatasource.MetadataRequest{ProviderTypeName: "nodeping"}, resp)
...
func TestDataSourceSchemaIsValid(t *testing.T) {
	...
	NewContactGroupDataSource().Schema(ctx, fwdatasource.SchemaRequest{}, resp)
